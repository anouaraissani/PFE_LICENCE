<template>
    <div id="app" >
      <div id='container' style="margin:10px ; width:190px; display: flex">
        ...
        <div class="padding-top">
          <ejs-combobox id='sections' :dataSource='sectionData' :enabled='sectionenabled' :fields='sectionfields' placeholder='Section' v-model="CmBx.section" ref="section"></ejs-combobox>
        </div>
        <div class="padding-top">
...
import ObsChart from '../Charts/ObsChart.vue'
...
export default {
  ...
  data(){
      return {
        ...
        params: {
        data: [
          ["Observation", "ADMIS", "ADMIS SES2", "ADMIS DET", "AJOURNE"],  
          ["Nbr etudiant", 150, 120, 55 ,11],
        ],
        header: 'row',
        border:false,
        stripe: true,
     ...
     onformationChange: function() {
        ...
        showGraph: function(){
          //console.log(document.getElementById('formations'));
           ...
           if(this.$refs.formation.value == '1' && this.$refs.spécialité.value == '101' && this.$refs.section.value == '201' && this.$refs.semestre.value == '05' && this.$refs.année.value == '21'){
             this.show = true;
           }
        }
  },
